...
public class NumericApplicationTests {
    ...
    public void welcomeMessage() throws Exception {
         this.mockMvc.perform(get("/")).andDo(print()).andExpect(content().string("Kubernetes DevSecOps"));
    }
    
//    @Test
//    public void incrementValue() throws Exception {
//        this.mockMvc.perform(get("/increment/0")).andDo(print()).andExpect(status().isOk())
